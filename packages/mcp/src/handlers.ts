...
export class ToolHandlers {
    ...
    /**
     * Sync indexed codebases from vector store collections
     ...
     *
     * Logic: Compare mcp-codebase-snapshot.json with vector store collections
     * - If local snapshot has extra directories (not in cloud), remove them
     * - If local snapshot is missing directories (exist in cloud), ignore them
     */
    private async syncIndexedCodebasesFromCloud(): Promise<void> {
        try {
            console.log(`[SYNC-CLOUD] 🔄 Syncing indexed codebases from vector store...`);
            ...
            console.log(`[SYNC-CLOUD] 📋 Found ${collections.length} collections in vector store`);
